    ...
    <section className="rounded-3xl border border-emerald-100 bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-7">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {starterCategories.map((starter) => {
            const alreadyUsed = existingNames.has(
              starter.name.toLowerCase(),
            );
            ...
            return (
              <button
                ...
                onClick={() =>
                  chooseStarter(starter.name, starter.type)
                }
      ...
      >
        <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <label className="text-sm font-black">
            ...
            <select
              ...
              onChange={(event) =>
                setCategoryType(
                  event.target.value as BudgetCategoryType,
                )
              }
              disabled={working}
              className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 font-normal"
        ...
        <p className="text-sm text-slate-600">
          {
            categoryTypes.find((type) => type.value === categoryType)
              ?.detail
          }
        </p>
