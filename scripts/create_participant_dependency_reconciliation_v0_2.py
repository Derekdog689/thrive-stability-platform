...
DOC = Path("docs/THRIVE_PROGRAM_PARTICIPANT_DEPENDENCY_RECONCILIATION_v0_1.md")
SQL = Path("docs/THRIVE_PROGRAMS_PARTICIPANT_LINKED_SELECT_POLICY_CANDIDATE_v0_2.sql")

doc = """# THRIVE Program Participant Dependency Reconciliation v0.1
...
sql = """-- THRIVE Programs Participant-Linked SELECT Policy Candidate v0.2
-- REVIEW ONLY
-- DO NOT EXECUTE
--
-- Purpose:
