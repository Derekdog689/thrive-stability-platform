-- THRIVE Supported Person Identity Schema Installation
-- Installation candidate version: v0.1
-- Status: REVIEW ONLY - INSTALLATION NOT APPROVED
-- DO NOT EXECUTE WITHOUT EXPLICIT INSTALLATION APPROVAL
--
-- Purpose:
...
-- REVIEW ONLY:
-- This installation candidate intentionally ends with COMMIT.
-- It must not be executed until separately reviewed and explicitly approved.
