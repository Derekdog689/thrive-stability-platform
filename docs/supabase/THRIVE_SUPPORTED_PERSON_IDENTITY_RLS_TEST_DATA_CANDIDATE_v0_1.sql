...
--
-- Replace only the six placeholder auth UUIDs below after separate review.
...
values
  ...
  -- AUTH USER PLACEHOLDERS: MUST BE REPLACED BEFORE APPROVED EXECUTION.
  ('admin_auth_user_id',   '00000000-0000-0000-0000-000000000001'),
  ('person_a_auth_user_id','00000000-0000-0000-0000-000000000002'),
  ('person_b_auth_user_id','00000000-0000-0000-0000-000000000003'),
  ('support_auth_user_id', '00000000-0000-0000-0000-000000000004'),
  ('viewer_auth_user_id',  '00000000-0000-0000-0000-000000000005'),
  ('outsider_auth_user_id','00000000-0000-0000-0000-000000000006');

-- ============================================================
-- 2. Mandatory placeholder guard
-- ============================================================
...
begin
  if exists (
    ...
    raise exception
      'REVIEW-ONLY STOP: replace and review all test auth-user UUID placeholders before execution';
  end if;
end;
$function$;
...
-- ============================================================
-- 9. Review-only boundary
-- ============================================================
--
-- This candidate intentionally ends with ROLLBACK.
-- No test records may remain from this review artifact.
