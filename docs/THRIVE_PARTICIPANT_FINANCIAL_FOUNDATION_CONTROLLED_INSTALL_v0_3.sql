-- THRIVE PARTICIPANT FINANCIAL FOUNDATION CONTROLLED INSTALL v0.3
-- APPROVED CONTROLLED INSTALLATION
-- EXECUTE ONCE, THEN RUN THE SEPARATE VERIFICATION QUERY
...
-- Approved controlled installation: persist the reviewed candidate.
commit;
